...
func (c *qRCodeServiceClient) GetQRCode(ctx context.Context, in *QRCodeRequest, opts ...grpc.CallOption) (*QRCodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/qr.QRCodeService/GetQRCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QRCodeService_GetQRCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qr.QRCodeService/GetQRCode",
	}
...
var QRCodeService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/proto/qr/qr.proto",
}
